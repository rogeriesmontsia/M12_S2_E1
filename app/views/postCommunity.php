...
<div class="container pb50">
    <div class="row">
        <div class="col-md-9 mb40 my-4">
            <article>
                <?php
                    echo '<img class="img-fluid mb30" src="'. $imagP->mostrarImagen(19,0). ' " alt="..." />';
                ?>
                <div class="post-content">
                    ...
                    <form role="form">
                        ...
                        <div class="clearfix float-right">
                            <button type="button" class="boto">Submit</button>
                        </div>
                    </form>
                </div>
            </article>
            ...
            <div class="mb40 my-4">
                <form>
                    <div class="input-group">
                        ...
                        <button class="boto" id="basic-addon2"><i class="fa fa-search"></i></button>
                    </div>
                </form>
            </div>
            <!--/col-->
